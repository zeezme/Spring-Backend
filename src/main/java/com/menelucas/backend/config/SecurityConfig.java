        ...
        http
                ...
                .authorizeHttpRequests((req) ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers(GET, "/get-forms").hasAuthority("ROLE_" + USER.name())
                                .requestMatchers(GET, "/get-forms/**").hasAuthority("ROLE_" + USER.name())
                                .requestMatchers(GET, "/get-form-items/**").hasAuthority("ROLE_" + USER.name())
                                .requestMatchers(GET, "/api/forms/get-who-answered/**").hasAuthority("ROLE_" + ADMIN.name())
                                .requestMatchers(DELETE, "/api/forms/delete-form-response/**").hasAuthority("ROLE_" + USER.name())
                                .requestMatchers(PATCH, "/api/forms/update-form-response/**").hasAuthority("ROLE_" + USER.name())
                                .anyRequest()
                                .authenticated()
                )
