package com.menelucas.backend.modules.auth.service;
...
import com.menelucas.backend.modules.auth.TokenType;
import com.menelucas.backend.modules.auth.dao.TokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        var userExists = repository.findAllByEmail(request.getEmail());
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        //System.out.println("Senha fornecida para autenticação: " + request.getPassword());

        var userFromDB = repository.findByEmail(request.getEmail()).orElse(null);
        /*if(userFromDB != null) {
            System.out.println("Senha Criptografada no Banco de Dados: " + userFromDB.getPassword());
        }*/
